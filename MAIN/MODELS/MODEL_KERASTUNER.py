...
def HyperbandBinaryOptim(skeleton, xTrain, yTrain, xVal, yVal, xTest, yTest, maxEpochs=50, binaryThreshold=0.90, prefix="HYPERBAND_BINARY"):
    # Initialise the tuner
    tuner = kt.Hyperband(
        skeleton,
        objective="val_accuracy",
...
def HyperbandCategoricalOptim(skeleton, xTrain, yTrain, xVal, yVal, xTest, yTest, maxEpochs=50, prefix="HYPERBAND_CATEGORICAL"):
    # Initialise the tuner
    tuner = kt.Hyperband(
        skeleton,
        objective="val_accuracy",
